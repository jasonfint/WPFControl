...
namespace FluentDesignSystem中的光照效果RevealBrush
{

    /// <summary>
    /// Paints a control border with a reveal effect using composition brush and light effects. 报错原因：7.0语法在2015不能实现
    /// </summary>
